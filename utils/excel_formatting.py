...
def format_and_save_report(result_df, fines_df, summary_df, pre_last_df, last_df, 
    ...
    for col in combined.columns:
        if col not in ("Артикул поставщика", "Виды штрафов"):
    ...
    totals["Себестоимость единицы товара"] = ''
    ...
    bej_fill = PatternFill(start_color="FFF0E68C", end_color="FFF0E68C", fill_type="solid")
    ...
    red_fill = PatternFill(start_color="FFFF6347", end_color="FFFF6347", fill_type="solid")
